        ...
        Column {
            ...
            Column {
                ...
                Repeater {
                    ...
                    model: [
                    { name: i18n.tr("Source code"), url: "https://github.com/sanderklootwijk/radiobe" },
                    { name: i18n.tr("Report issues"),  url: "https://github.com/sanderklootwijk/radiobe/issues" }
                    ]
