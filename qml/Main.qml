...
MainView {
    ...
    Settings {
        ...
        property string regionName: "FirstRun"
    ...
    Image {
        ...
        source: "https://stubru.be/resources/favicon-stubru/favicon-16x16.png"
    }
    ...
    Timer {
        ...
        onTriggered: {
            if (testImg.status == Image.Ready) {
                ...
                testImg.source = ""
                testImg.source = "https://stubru.be/resources/favicon-stubru/favicon-16x16.png"
                start()
            }
        }
    }    
